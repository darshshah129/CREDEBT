...
public final class Locators {
    ...
    public static By AMORTISATION_ICON = By.xpath("//a[@ng-reflect-router-link='tte/amortisation']//span[1]");
    public static By AMORTISATION_TYPE_DROPDOWN = By.xpath("//ng-select[@placeholder='All']\n");
    public static By AMORTISATION_COUNT = By.xpath("//span[@id='ag-700-row-count']");
}
